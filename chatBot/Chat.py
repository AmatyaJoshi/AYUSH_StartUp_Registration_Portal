...
try:
    data = pd.read_csv('ayush_faqs.csv')
...
template_text = """
You are an expert Customer Service Associate of Ministry of AYUSH. Below are some examples of questions and their appropriate answers:
...
st.title('AYUSH Customer Support')
...
if input_text:
    ...
    if dataset_response:
        ...
        prompt_messages = [
            ("system", "You are an expert Customer Service Associate hired by Ministry of AYUSH. Please use the following examples to help answer the user's question."),
            ("user", prompt_text)
        ]
